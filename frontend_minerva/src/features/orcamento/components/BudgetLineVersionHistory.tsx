      ...
      <CardContent>
        {versions.length === 0 ? (
          <div className="text-center py-8">
            ...
            <h3 className="mt-2 text-sm font-semibold text-foreground">Nenhuma versão encontrada</h3>
            ...
            <TabsContent value="comparison">
              {selectedVersion ? (
                <ScrollArea className="h-96">
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground/80">Tipo de Despesa:</label>
                        <p className="text-sm">{selectedVersion.expense_type}</p>
                      </div>

                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground/80">Centro Gestor:</label>
                        <p className="text-sm">{selectedVersion.management_center_name || '-'}</p>
                      </div>

                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground/80">Centro Solicitante:</label>
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground/80">Objeto:</label>
                        <p className="text-sm">{selectedVersion.object || '-'}</p>
                      </div>

                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground/80">Valor Orçado:</label>
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground/80">Status do Processo:</label>
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground/80">Status do Contrato:</label>
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground/80">Fiscal Principal:</label>
                        <p className="text-sm">{selectedVersion.main_fiscal_name || '-'}</p>
                      </div>

                      <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground/80">Fiscal Substituto:</label>
                      ...
                      <div className="space-y-2 col-span-full">
                        <label className="text-sm font-medium text-foreground/80">Motivo da Alteração:</label>
                        <p className="text-sm bg-primary/5 p-2 rounded">{selectedVersion.change_reason}</p>
                      </div>
                    </div>
                  </div>
                </ScrollArea>
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="mt-2 text-sm font-semibold text-foreground">Selecione uma versão</h3>
                  <p className="mt-1 text-sm text-muted-foreground">
