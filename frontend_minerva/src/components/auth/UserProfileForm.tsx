...
export function UserProfileForm({ isOpen, onClose }: UserProfileFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const profileResponse = await apiClient(API_ENDPOINTS.AUTH.UPDATE_PROFILE, {
        method: "PUT",
        body: JSON.stringify({
      ...
      if (formData.currentPassword && formData.newPassword) {
        const passwordResponse = await apiClient(API_ENDPOINTS.AUTH.CHANGE_PASSWORD, {
          method: "POST",
          body: JSON.stringify({
          ...
          <div className="grid gap-5 py-4">
            ...
            <div className="grid gap-2">
              ...
              <AvatarPicker
                ...
                onChange={(id) => setFormData(prev => ({ ...prev, avatar: id }))}
              />
            </div>
